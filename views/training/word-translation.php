...
$this->title = Yii::t('trainingWordTranslation', 'Training');
\app\assets\TrainingWordTranslationAsset::register($this);
use yii\helpers\Url; ?>
...
<div class="main-container">
    ...
    <div class="page-title">
        <div class="page-name">
            <div class="page-name-text"><?= Yii::t('trainingWordTranslation', 'Word-translation') ?></div>
        </div>
    ...
    <div class="training-card">
        <div class="training-word">
            ...
            <?php if($qStep > count($qWords)): ?>
                <div class="training-word-text">
                    <?= Yii::t('trainingWordTranslation', 'Results') ?>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="training-buttons">
            <a class="training-button exit" href="<?= Url::to(['training/', 'v'=>Yii::$app->request->get('v')])?>">
                <div class="training-button-text exit">
                    <?= Yii::t('trainingWordTranslation', 'Exit') ?>
                </div>
            </a>
            <?php if(count($qAnswers) < $qStep and $qStep <= count($qWords)): ?>
                <div data-option class="training-button skip">
                    <div class="training-button-text  skip">
                        <?= Yii::t('trainingWordTranslation', 'skip') ?>
                    </div>
                </div>
            <?php endif; ?>
            <?php if(count($qAnswers) == $qStep and $qStep <= count($qWords)): ?>
                <div data-option class="training-button next">
                    <div class="training-button-text next">
                        <?= Yii::t('trainingWordTranslation', 'Next') ?>
                    </div>
            ...
            <?php endif; ?>
            <?php if($qStep > count($qWords)): ?>
                <a class="training-button continue" href="<?= Url::to(['training/word-translation', 'v'=>Yii::$app->request->get('v')])?>">
                    <div class="training-button-text continue">
                        <?= Yii::t('trainingWordTranslation', 'Continue') ?>
                    </div>
